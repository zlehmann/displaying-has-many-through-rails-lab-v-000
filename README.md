...
First, fork and clone this lab. <em>Before anything</em>, when you generate models, controllers, etc., be sure to include the `--no-test-framework` option so that it skips tests (which we already have).
